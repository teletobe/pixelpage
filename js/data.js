...
const translations = {
  en: {
    ...
    "cs.title": "CS JOURNEY",
    "cs.description":
      "A pixel sidescroller through my computer science education and work experience. Use \u25c4 \u25ba to travel between chapters.",
    "cs.level.label": "DEGREE:",
    "cs.level.value": "MSc. Media & Human-Centred Computing",
    "cs.focus.label": "FOCUS:",
    "cs.focus.value": "Interactive Media, AI Ethics, UX Research",
    "cs.location.label": "BASED IN:",
    "cs.location.value": "Vienna, Austria",
    "cs.footer": "use \u25c4 \u25ba to explore each chapter",
  ...
  de: {
    ...
    "cs.title": "INFORMATIK REISE",
    "cs.description":
      "Ein Pixel-Sidescroller durch meine Informatik-Ausbildung und Berufserfahrung. Nutze \u25c4 \u25ba um zwischen den Kapiteln zu navigieren.",
    "cs.level.label": "ABSCHLUSS:",
    "cs.level.value": "MSc. Media & Human-Centred Computing",
    "cs.focus.label": "SCHWERPUNKT:",
    "cs.focus.value": "Interaktive Medien, KI-Ethik, UX-Forschung",
    "cs.location.label": "WOHNHAFT:",
    "cs.location.value": "Wien, \u00d6sterreich",
    "cs.footer": "\u25c4 \u25ba nutzen, um die Kapitel zu erkunden",
    ...
    "cs.work.placeholder.summary": "Platzhalter f\u00fcr zuk\u00fcnftige Eintr\u00e4ge.",
